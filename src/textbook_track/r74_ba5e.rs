...
pub fn rosalind_ba5e() {
    let contents = utils::input_from_file("data/textbook_track/rosalind_ba5e.txt");
...
pub fn read_scoring_matrix(filename: &str) -> (Array2<isize>, Vec<char>) {
    let contents = utils::input_from_file(filename);
