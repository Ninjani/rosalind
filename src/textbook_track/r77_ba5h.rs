...
pub fn rosalind_ba5h() {
    let contents = utils::input_from_file("data/textbook_track/rosalind_ba5h.txt");
...
fn fitting_align(string_1: &str, string_2: &str, parameters: &AlignmentParameters) -> (isize, String, String) {
